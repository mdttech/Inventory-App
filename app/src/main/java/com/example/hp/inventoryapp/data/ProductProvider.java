...
public class ProductProvider extends ContentProvider {
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        if (quantity == null) {
            throw new IllegalArgumentException("Products requires a quantity");
        }
        ...
        if (supplierName == null) {
            throw new IllegalArgumentException("Products requires a supplier name");
        }
        ...
        if (supplierPhoneNumber == null) {
            throw new IllegalArgumentException("Products requires a supplier phone number");
        }
